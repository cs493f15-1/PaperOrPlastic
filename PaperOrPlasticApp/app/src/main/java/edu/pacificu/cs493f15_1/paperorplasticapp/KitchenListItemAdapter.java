...
public class KitchenListItemAdapter extends ArrayAdapter<ListItem>
{
    private ArrayList<ListItem> mItemArray;
    int mLayoutResourceId;
    Context mContext;

    public KitchenListItemAdapter (Context context, int layoutResourceId, ArrayList<ListItem> items)
    {
