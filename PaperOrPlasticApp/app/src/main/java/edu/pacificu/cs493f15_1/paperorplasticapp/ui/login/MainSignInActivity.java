...
package edu.pacificu.cs493f15_1.paperorplasticapp.ui.login;
...
import edu.pacificu.cs493f15_1.paperorplasticapp.ui.BaseActivity;
 ...
 ***************************************************************************************************/
  private void initializeActivity()
  {
    ...
    mAuthSuccess = false;
    //LinearLayout linearLayoutLoginForm = (LinearLayout) findViewById(R.id.emailLoginForm);
    //initializeBackground(linearLayoutLoginForm);
  }
    ...
    if (null != error)
    {
      switch (error.getCode())
      {
        ...
        case FirebaseError.USER_DOES_NOT_EXIST:
          errorMessage = "Error: Mistyped Email.";
          break;
        default:
